...
/**
 * A utility class that provides a mapping between country codes and country names.
 * Contains a comprehensive list of countries with their ISO 3166-1 alpha-2 codes.
 */
public class Countries {
     ...
     *
     * @param code the ISO 3166-1 alpha-2 country code (case insensitive)
     * @return the country name corresponding to the code, or null if not found
     */
